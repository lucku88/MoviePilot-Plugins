...
| 2 | [🎭 SQ表情 (SQEmoji)](#2--sq表情-sqemoji) | v0.1.9 | 支持 SQ 站点老虎机、开包、舞台演出和执行记录展示 | 站点 |
...
- 更新说明：
  ...
  - v0.1.9: 将状态页标题统一为“表情演出”，并补做仓库隐私检查。
...
- 特点：
  ...
  - 🔀 风格1会随机取3张海报叠层，风格2随机取1张，风格3随机取9张做九宫格
  - 🧹 风格3会按图片内容优先去重后再凑满九宫格，减少同一海报在一个封面里重复出现
  - 🏷️ 未配置 YAML 副标题时，会对常见媒体库名自动补默认副标题
