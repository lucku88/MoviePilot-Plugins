...
| 插件 | 版本 | 说明 | 标签 |
| --- | --- | --- | --- |
| `Vue-农场` | `v0.1.9` | 收菜、种植、出售、获取执行记录 | 站点 |
| `Vue-魔丸` | `v0.1.15` | 兑换、搬砖、清沙滩、炼造、获取执行记录 | 站点 |
| `Vue-玩偶` | `v0.1.9` | 盲盒、回收、展出、获取执行记录 | 站点 |
| `Vue-表情` | `v0.1.1` | 老虎机、开包、舞台演出、获取执行记录 | 站点 |
| `Vue-面板` | `v0.1.3` | 思齐签到与 HNR领取固定单卡并独立设置 Cron，New API 签到在同一模块内管理多站点卡片 | 站点 |
| `飞牛影视媒体库封面生成器` | `v0.1.5` | 生成静态封面并回写飞牛影视 | 媒体服务器 |
...
### 📊 Vue-面板
- 思齐签到与 HNR领取使用固定单卡并独立设置 Cron，New API 签到在同一模块内管理多站点卡片和模块历史。
