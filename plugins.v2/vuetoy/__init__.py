...
class VueToy(_PluginBase):
    ...
    def get_api(self) -> List[Dict[str, Any]]:
        return [
            ...
            {"path": "/refresh", "endpoint": self._refresh_data, "methods": ["POST"], "auth": "bear", "summary": "刷新 Vue-玩偶状态"},
    ...
    def get_service(self) -> List[Dict[str, Any]]:
        ...
        if self._enabled:
            ...
            if next_run:
                services.append({
                    "id": "VueToy_auto",
                    "name": "Vue-玩偶初始化" if self._bootstrap_pending else "Vue-玩偶智能调度",
                    "trigger": "date",
    ...
    def _refresh_data(self):
        try:
            ...
            return {"success": True, "message": "Vue-玩偶状态已刷新", "toy_status": toy_status, "status": self._build_status(auto_refresh=False)}
        except Exception as err:
            detail = self._get_error_detail(err)
