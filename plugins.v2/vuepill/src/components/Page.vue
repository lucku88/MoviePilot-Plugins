        ...
        <div class="primary-grid mb-3">
          ...
          <v-card-text class="exchange-body">
            ...
            <div class="exchange-action-panel">
              <div class="exchange-quantity-field">
                <span class="exchange-quantity-label">兑换数量</span>
                <v-text-field
...
.recipe-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}.recipe-card{display:grid;grid-template-columns:minmax(0,1fr) auto;grid-template-areas:"head controls" "ingredients ingredients";align-items:start;gap:10px 12px;min-height:112px;padding:12px;border-radius:13px;background:rgba(var(--v-theme-surface),.68);border:1px solid rgba(6,182,212,.16)}.recipe-card--disabled{border-color:rgba(var(--v-theme-on-surface),.08)}.recipe-head{grid-area:head;display:flex;align-items:center;gap:10px;min-width:0}.recipe-icon{width:38px;height:38px;border-radius:11px;display:grid;place-items:center;background:rgba(6,182,212,.12);font-size:22px;flex:0 0 38px}.recipe-title{min-width:0}.recipe-title strong,.recipe-title small{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.recipe-title strong{font-size:13px;color:rgba(var(--v-theme-on-surface),.84)}.recipe-title small{margin-top:3px;font-size:10px;color:rgba(var(--v-theme-on-surface),.5)}.recipe-ingredients{grid-area:ingredients;display:flex;align-content:flex-start;gap:6px;flex-wrap:wrap;min-height:0;margin:0}.recipe-ingredients span{padding:4px 7px;border-radius:999px;background:rgba(var(--v-theme-on-surface),.055);font-size:10px;color:rgba(var(--v-theme-on-surface),.65)}.recipe-controls{grid-area:controls;display:flex;align-items:center;justify-content:flex-end;align-self:center;min-height:40px;margin:0;padding:0}.recipe-controls__group{display:flex;align-items:center;justify-content:flex-end;gap:8px;width:auto;max-width:none;margin-left:auto}.recipe-quantity-input{width:88px;flex:0 0 88px}.recipe-controls :deep(.v-btn){min-width:64px}
...
@media(max-width:1100px){.primary-grid{grid-template-columns:1fr}.recipe-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:900px){.overview-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.resource-grid,.stats-columns{grid-template-columns:1fr}}
@media(max-width:600px){.siqi-page{padding:14px}.siqi-topbar{align-items:flex-start;gap:10px}.siqi-topbar__right :deep(.v-btn){min-width:44px!important;padding-inline:0!important}.overview-grid>.v-col{padding:4px!important}.stat-card{padding:10px;gap:8px}.stat-icon{width:34px;height:34px;flex-basis:34px}.stat-value{font-size:17px}.card-subtitle{display:none}.schedule-board-body{padding:14px!important}.neu-action-card{grid-template-columns:32px minmax(0,1fr);row-gap:10px;padding:12px}.schedule-action{grid-column:1/-1;width:100%}.schedule-meta span{flex:1 1 100%}.exchange-summary{grid-template-columns:1fr}.exchange-action-panel{justify-content:space-between;gap:8px}.exchange-quantity-field{flex:1}.exchange-quantity-input{width:88px;flex-basis:88px}.exchange-action-button{min-width:96px!important}.siqi-card-title--inventory{flex-wrap:wrap;gap:8px}.siqi-card-title--inventory :deep(.v-spacer){display:none}.inventory-title-actions{width:100%;justify-content:stretch}.inventory-title-actions :deep(.v-btn){flex:1 1 0}.inventory-grid{grid-template-columns:1fr}.recipe-grid{grid-template-columns:1fr}.recipe-card{grid-template-columns:1fr;grid-template-areas:"head" "ingredients" "controls"}.recipe-controls{justify-content:flex-end}.recipe-controls :deep(.v-btn){min-width:72px}.batch-gift-row{grid-template-columns:auto minmax(0,1fr)}.batch-gift-row :deep(.v-input){grid-column:2}.history-item{grid-template-columns:minmax(0,1fr) auto;gap:6px;padding-inline:10px}.history-detail{font-size:11px}.history-time{text-align:right;white-space:nowrap}.dialog-header{align-items:flex-start}.dialog-avatar{width:42px;height:42px;flex-basis:42px}.stats-filters{align-items:stretch;flex-direction:column}.stats-filters :deep(.v-btn-toggle),.stats-filters :deep(.v-btn){width:100%}.stats-filters :deep(.v-btn-toggle .v-btn){flex:1}.summary-grid{grid-template-columns:1fr}}
</style>
