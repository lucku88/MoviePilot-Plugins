...
const Page_vue_vue_type_style_index_0_scoped_a74b4b02_lang = '';
...
const _withScopeId = n => (_pushScopeId("data-v-a74b4b02"),n=n(),_popScopeId(),n);
...
const _hoisted_38 = { class: "vp-tool-actions" };
const _hoisted_39 = { class: "vp-field vp-field-compact" };
const _hoisted_40 = ["max"];
const _hoisted_41 = { class: "vp-note" };
const _hoisted_42 = { key: 0 };
const _hoisted_43 = { class: "vp-tool exchange" };
const _hoisted_44 = { class: "vp-head vp-head-action vp-tool-head" };
const _hoisted_45 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("div", { class: "vp-tool-title" }, "💰 兑换魔力", -1));
const _hoisted_46 = { class: "vp-tool-actions" };
const _hoisted_47 = { class: "vp-field vp-field-compact" };
          ...
          _createElementVNode("article", _hoisted_35, [
            ...
            _createElementVNode("div", _hoisted_41, [
              ...
              (magicPillRecipe.value?.materials?.length)
                ? (_openBlock(), _createElementBlock("span", _hoisted_42, " · 材料 " + _toDisplayString(magicPillRecipe.value.materials.join(' / ')), 1))
                : _createCommentVNode("", true)
            ])
          ]),
...
const PageView = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-a74b4b02"]]);
