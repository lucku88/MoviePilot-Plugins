...
const Page_vue_vue_type_style_index_0_scoped_bd897990_lang = '';
...
const _withScopeId = n => (_pushScopeId("data-v-bd897990"),n=n(),_popScopeId(),n);
...
const _hoisted_7 = { class: "vp-chips" };
...
const _hoisted_17 = { class: "vp-head compact" };
...
const _hoisted_19 = { class: "vp-list" };
const _hoisted_20 = { class: "vp-grid-2" };
const _hoisted_21 = { class: "vp-card vp-panel brick" };
const _hoisted_22 = { class: "vp-head" };
...
const _hoisted_24 = { class: "vp-title-strong" };
const _hoisted_25 = { class: "vp-countdown" };
const _hoisted_26 = { class: "vp-facts" };
const _hoisted_27 = { class: "vp-fact" };
const _hoisted_28 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("span", { class: "vp-kicker" }, "今日进度", -1));
const _hoisted_29 = { class: "vp-fact" };
const _hoisted_30 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("span", { class: "vp-kicker" }, "下次模式", -1));
const _hoisted_31 = { class: "vp-card vp-panel beach" };
const _hoisted_32 = { class: "vp-head" };
...
const _hoisted_34 = { class: "vp-title-strong" };
const _hoisted_35 = { class: "vp-countdown" };
const _hoisted_36 = { class: "vp-facts" };
const _hoisted_37 = { class: "vp-fact" };
const _hoisted_38 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("span", { class: "vp-kicker" }, "当前结果", -1));
const _hoisted_39 = { class: "vp-fact" };
const _hoisted_40 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("span", { class: "vp-kicker" }, "自动后续", -1));
const _hoisted_41 = { class: "vp-card vp-panel stash" };
const _hoisted_42 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("div", { class: "vp-head" }, [
  /*#__PURE__*/_createElementVNode("div", null, [
    /*#__PURE__*/_createElementVNode("div", { class: "vp-kicker" }, "物品栏"),
    /*#__PURE__*/_createElementVNode("h2", { class: "vp-section-title" }, "当前库存")
  ]),
  /*#__PURE__*/_createElementVNode("div", { class: "vp-note" }, "材料、工具和魔丸都会在这里汇总显示。")
], -1));
const _hoisted_43 = { class: "vp-tool-grid" };
const _hoisted_44 = { class: "vp-tool craft" };
const _hoisted_45 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("div", { class: "vp-tool-title" }, "⚗️ 一键炼造魔丸", -1));
const _hoisted_46 = { class: "vp-note" };
...
const _hoisted_52 = { class: "vp-tool exchange" };
const _hoisted_53 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("div", { class: "vp-tool-title" }, "💰 兑换魔力", -1));
const _hoisted_54 = { class: "vp-note" };
...
const _hoisted_61 = { class: "vp-item-icon" };
const _hoisted_62 = { class: "vp-item-name" };
const _hoisted_63 = { class: "vp-item-count" };
const _hoisted_64 = { class: "vp-card vp-panel history" };
const _hoisted_65 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("div", { class: "vp-head" }, [
  /*#__PURE__*/_createElementVNode("div", null, [
    /*#__PURE__*/_createElementVNode("div", { class: "vp-kicker" }, "最近记录"),
...
const _hoisted_68 = { class: "vp-history-top" };
const _hoisted_69 = { class: "vp-note" };
    ...
    _createElementVNode("div", _hoisted_1, [
      ...
      _createElementVNode("section", _hoisted_20, [
        ...
        _createElementVNode("article", _hoisted_31, [
          ...
          _createElementVNode("div", _hoisted_34, _toDisplayString(beachHeadline.value), 1),
          _createElementVNode("div", _hoisted_35, _toDisplayString(beachCountdownText.value), 1),
      ...
      _createElementVNode("section", _hoisted_41, [
        ...
        _createElementVNode("div", _hoisted_43, [
          _createElementVNode("article", _hoisted_44, [
            ...
            _createElementVNode("div", _hoisted_46, [
              ...
              (magicPillRecipe.value?.materials?.length)
                ? (_openBlock(), _createElementBlock("span", _hoisted_47, " · 材料 " + _toDisplayString(magicPillRecipe.value.materials.join(' / ')), 1))
                : _createCommentVNode("", true)
            ]),
          ...
          _createElementVNode("article", _hoisted_52, [
            _hoisted_53,
            _createElementVNode("div", _hoisted_54, "价格 " + _toDisplayString(exchangePriceText.value) + " · 可兑换 " + _toDisplayString(exchange.value.max_count || 0) + " 颗", 1),
        ...
        (pill.value.inventory?.empty)
          ? (_openBlock(), _createElementBlock("div", _hoisted_59, _toDisplayString(pill.value.inventory?.empty_text), 1))
          : (_openBlock(), _createElementBlock("div", _hoisted_60, [
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(inventoryItems.value, (item) => {
                return (_openBlock(), _createElementBlock("article", {
                  ...
                  _createElementVNode("div", _hoisted_61, _toDisplayString(item.icon), 1),
                  _createElementVNode("div", _hoisted_62, _toDisplayString(item.name), 1),
                  _createElementVNode("div", _hoisted_63, _toDisplayString(item.count), 1)
                ], 6))
              }), 128))
            ]))
      ]),
      _createElementVNode("section", _hoisted_64, [
        ...
        (!historyItems.value.length)
          ? (_openBlock(), _createElementBlock("div", _hoisted_66, "暂无执行记录"))
          : (_openBlock(), _createElementBlock("div", _hoisted_67, [
              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(historyItems.value, (item) => {
                return (_openBlock(), _createElementBlock("article", {
                  ...
                  _createElementVNode("div", _hoisted_69, _toDisplayString((item.lines || []).join(' / ')), 1)
                ]))
              }), 128))
            ]))
      ])
...
const PageView = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-bd897990"]]);
