...
const _hoisted_15 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("div", { class: "pc-panel-head" }, [
  /*#__PURE__*/_createElementVNode("div", null, [
    /*#__PURE__*/_createElementVNode("div", { class: "pc-kicker" }, "常见方式"),
    /*#__PURE__*/_createElementVNode("h2", null, "任务类型说明")
  ])
], -1));
const _hoisted_16 = { class: "pc-note-grid" };
const _hoisted_17 = { class: "pc-panel" };
const _hoisted_18 = { class: "pc-panel-head pc-panel-head-wrap" };
...
const _hoisted_20 = { class: "pc-actions" };
const _hoisted_21 = {
  key: 0,
  class: "pc-empty"
};
const _hoisted_22 = { class: "pc-task-title" };
const _hoisted_23 = { class: "pc-mini" };
const _hoisted_24 = { class: "pc-title-meta" };
const _hoisted_25 = { class: "pc-task-layout" };
const _hoisted_26 = { class: "pc-task-group" };
const _hoisted_27 = { class: "pc-group-head" };
const _hoisted_28 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("div", { class: "pc-kicker" }, "基础信息", -1));
const _hoisted_29 = { class: "pc-mini" };
const _hoisted_30 = { class: "pc-form-grid" };
...
const _hoisted_39 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("div", { class: "pc-group-head" }, [
  /*#__PURE__*/_createElementVNode("div", { class: "pc-kicker" }, "响应匹配"),
  /*#__PURE__*/_createElementVNode("div", { class: "pc-mini" }, "可用关键字或正则匹配响应内容，支持用 `|` 分隔多个条件。")
], -1));
const _hoisted_40 = { class: "pc-form-grid pc-form-grid-wide" };
const _hoisted_41 = { class: "pc-task-footer" };
const _hoisted_42 = { class: "pc-mini" };
    ...
    _createElementVNode("div", _hoisted_1, [
      ...
      _createElementVNode("section", _hoisted_14, [
        ...
        _createElementVNode("div", _hoisted_16, [
          (_openBlock(), _createElementBlock(_Fragment, null, _renderList(modeGuides, (item) => {
                        ...
                        default: _withCtx(() => [
                          _createElementVNode("div", _hoisted_22, [
                            _createElementVNode("div", null, [
                              ...
                              _createElementVNode("div", _hoisted_23, _toDisplayString(resolveTaskTypeLabel(task.task_type)), 1)
                            ]),
                          ...
                          _createElementVNode("div", _hoisted_25, [
                            _createElementVNode("section", _hoisted_26, [
                              _createElementVNode("div", _hoisted_27, [
                                _hoisted_28,
                                _createElementVNode("div", _hoisted_29, _toDisplayString(taskTypeDescription(task.task_type)), 1)
                              ]),
                            ...
                            (usesRequestPayload(task.task_type))
                              ? (_openBlock(), _createElementBlock("section", _hoisted_35, [
                                  _hoisted_36,
                                  _createElementVNode("div", _hoisted_37, [
                                    _createVNode(_component_v_textarea, {
                                      modelValue: task.request_headers,
                                      "onUpdate:modelValue": $event => ((task.request_headers) = $event),
                                      label: "请求头",
                                      rows: "5",
                                      "auto-grow": "",
                                      variant: "outlined",
                                    ...
                                    _createVNode(_component_v_textarea, {
                                      modelValue: task.request_body,
                                      "onUpdate:modelValue": $event => ((task.request_body) = $event),
                              ...
                              : _createCommentVNode("", true),
                            (usesKeywordMatcher(task.task_type))
                            ...
                            _createElementVNode("div", _hoisted_41, [
                              _createElementVNode("div", _hoisted_42, _toDisplayString(taskTypeDescription(task.task_type)), 1),
                              _createVNode(_component_v_btn, {
                                color: "error",
                                variant: "tonal",
