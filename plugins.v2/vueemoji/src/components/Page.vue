    ...
    <div class="siqi-content">
      ...
      <template v-else>
        ...
        <div class="emoji-hub-grid">
          <div class="emoji-hub-stack">
            <v-card flat class="siqi-card slot-card">
            ...
            <v-card v-if="emoji.recruit" flat class="siqi-card recruit-card">
...
@media (max-width: 1100px){.emoji-hub-grid{grid-template-columns:1fr;align-items:start}.emoji-hub-grid>.emoji-hub-stack,.emoji-hub-grid>.siqi-card{height:auto}.emoji-hub-stack{grid-template-rows:auto auto}.emoji-hub-stack>.siqi-card{height:auto}.primary-grid{grid-template-columns:1fr}}
...
.next-run-card{margin-bottom:12px!important}.next-run-body{display:flex;align-items:center;gap:12px;min-height:72px;padding:10px 14px!important;background:rgba(76,175,80,.08)}.next-run-icon{width:40px;height:40px;display:grid;place-items:center;flex:0 0 40px;border-radius:12px;color:#16a34a;background:rgba(34,197,94,.13)}.next-run-copy{min-width:0;flex:1 1 auto}.next-run-title{font-size:14px;font-weight:800}.next-run-guard{margin-top:3px;color:rgba(var(--v-theme-on-surface),.55);font-size:10px;line-height:1.35}.next-run-times{display:flex;align-items:center;justify-content:flex-end;flex-wrap:wrap;gap:8px}.next-run-time{display:grid;gap:1px;min-width:142px;text-align:right}.next-run-time span{color:rgba(var(--v-theme-on-surface),.52);font-size:10px}.next-run-time strong{color:rgba(var(--v-theme-on-surface),.86);font-size:11px;font-variant-numeric:tabular-nums;white-space:nowrap}.next-run-card .schedule-run-btn{min-width:100px!important;min-height:32px!important;height:32px!important;border-radius:999px!important;font-size:11px!important}.next-run-card .summary-panel{margin:0 14px 12px}.siqi-card-title--recruit{background:rgba(236,72,153,.08)}.recruit-card{display:flex;flex-direction:column}.recruit-body{flex:1;align-content:center;display:grid;gap:8px;padding:10px 12px!important}.recruit-summary{display:flex;align-items:center;gap:8px;min-width:0}.recruit-summary__icon{width:32px;height:32px;display:grid;place-items:center;flex:0 0 32px;border-radius:10px;color:#ec4899;background:rgba(236,72,153,.12)}.recruit-summary__copy{min-width:0;flex:1;display:flex;flex-direction:column}.recruit-summary__copy strong{overflow:hidden;color:rgba(var(--v-theme-on-surface),.84);font-size:11px;text-overflow:ellipsis;white-space:nowrap}.recruit-summary__copy span{margin-top:2px;overflow:hidden;color:rgba(var(--v-theme-on-surface),.48);font-size:9px;line-height:1.3;text-overflow:ellipsis;white-space:nowrap}.recruit-summary :deep(.v-btn){height:36px;min-height:36px!important;min-width:58px!important;padding-inline:10px!important;font-size:10px!important}.recruit-meta-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.recruit-meta{min-width:0;padding:6px 8px;border:1px solid rgba(236,72,153,.12);border-radius:9px;background:rgba(var(--v-theme-surface),.62)}.recruit-meta span,.recruit-meta strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.recruit-meta span{color:rgba(var(--v-theme-on-surface),.45);font-size:8px}.recruit-meta strong{margin-top:2px;overflow:hidden;color:rgba(var(--v-theme-on-surface),.76);font-size:9px;font-variant-numeric:tabular-nums;text-overflow:ellipsis;white-space:nowrap}.siqi-card-title--slot{background:rgba(249,115,22,.09)}.slot-card{display:flex;flex-direction:column}.slot-card-body{flex:1;min-height:0;display:flex;align-items:center;justify-content:center;flex-direction:column;text-align:center;padding:12px!important}.slot-today{color:rgba(var(--v-theme-on-surface),.66);font-size:10px;line-height:1.4}.slot-reels--large{width:100%;max-width:300px;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px;margin:10px auto}.slot-reels--large span{width:auto;height:56px;display:grid;place-items:center;border:1px solid rgba(249,115,22,.2);border-radius:11px;background:rgba(var(--v-theme-surface),.72);font-size:28px}.slot-center-row{justify-content:center}.slot-center-row .number-input{width:76px}.slot-center-row :deep(.v-btn){min-width:54px!important}.log-card{margin-top:0}.log-body{max-height:430px;overflow-y:auto;padding:12px!important}.log-list{display:grid;gap:8px}.log-item{min-width:0;padding:10px 12px;border:1px solid rgba(var(--v-theme-on-surface),.08);border-radius:11px;background:rgba(var(--v-theme-surface),.68);font-size:11px;line-height:1.5}.log-item-head{display:flex;align-items:center;justify-content:center;gap:6px;flex-wrap:wrap;color:rgba(var(--v-theme-on-surface),.84)}.log-item-head strong{font-size:11px}.log-item-head time{color:rgba(var(--v-theme-on-surface),.5);font-size:10px;font-variant-numeric:tabular-nums}.log-item-detail{margin-top:3px;color:rgba(var(--v-theme-on-surface),.68);overflow-wrap:anywhere;text-align:center}.log-item-detail:empty{display:none}
...
.emoji-hub-grid>.siqi-card{margin-bottom:0!important}
</style>
