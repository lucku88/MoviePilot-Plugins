      ...
      <template v-else>
        ...
        <div class="primary-grid mb-3">
          ...
          <v-card flat class="siqi-card bag-card">
            <v-card-title class="siqi-card-title d-flex align-center"><v-icon icon="mdi-bag-personal-outline" size="19" color="orange" class="mr-2" />我的表情包<v-spacer /><span class="section-count">{{ bags.length }} 个层级</span></v-card-title>
        ...
        <v-card flat class="siqi-card catalog-card mb-3">
          <v-card-title class="siqi-card-title catalog-title-row"><span class="card-title-copy"><v-icon icon="mdi-book-open-page-variant-outline" size="19" color="blue" />表情图鉴</span><span class="catalog-progress"><strong>{{ catalogStat.value }}</strong><small>{{ catalogStat.desc || '按层级切换查看演员' }}</small></span></v-card-title>
        ...
        <v-card flat class="siqi-card history-card">
          <v-card-title class="siqi-card-title d-flex align-center"><v-icon icon="mdi-history" size="19" color="success" class="mr-2" />执行历史</v-card-title>
...
.actor-scroll{max-height:350px;overflow-y:auto;padding:2px}.actor-scroll.expanded{max-height:560px}.actor-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(72px,1fr));gap:7px}.actor-card{position:relative;min-width:0;min-height:78px;padding:8px 6px;border:1px solid var(--actor-card-border);border-radius:11px;color:var(--actor-card-color);background:var(--actor-card-bg);font:inherit;cursor:pointer}.actor-card:not(:disabled):hover{transform:translateY(-1px);box-shadow:0 5px 12px rgba(15,23,42,.08)}.actor-main{font-size:27px;line-height:1.2}.actor-attr{margin-top:3px;font-size:9px;font-weight:700}.actor-count{position:absolute;top:5px;right:5px;padding:1px 5px;border-radius:999px;color:rgba(var(--v-theme-on-surface),.7);background:rgba(var(--v-theme-surface),.72);font-size:8px}.actor-actions{display:flex;justify-content:center;gap:8px;margin-top:10px}
.effect-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(190px,1fr));gap:8px}.effect-card{min-width:0;min-height:108px;display:flex;align-items:flex-start;flex-direction:column;gap:4px;padding:12px;border:1px solid rgba(249,115,22,.14);border-radius:12px;color:rgba(var(--v-theme-on-surface),.72);background:rgba(249,115,22,.045);font:inherit;text-align:left;cursor:pointer}.effect-card.active{border-color:rgba(249,115,22,.38);background:rgba(249,115,22,.1);box-shadow:inset 0 0 0 1px rgba(249,115,22,.1)}.effect-card.locked{filter:grayscale(.25)}.effect-title{color:rgba(var(--v-theme-on-surface),.85);font-size:12px;font-weight:850}.effect-boost{color:#f97316;font-size:10px;font-weight:750}.effect-subline,.effect-unlock{color:rgba(var(--v-theme-on-surface),.46);font-size:10px}
.stage-toolbar{display:flex;align-items:center;justify-content:space-between;gap:14px;margin:10px 0;padding:11px 12px;border:1px solid rgba(var(--v-theme-on-surface),.065);border-radius:12px;background:rgba(var(--v-theme-surface),.64)}.stage-toolbar-copy{min-width:0;display:flex;flex-direction:column}.stage-toolbar-copy strong{color:rgba(var(--v-theme-on-surface),.82);font-size:12px}.stage-toolbar-copy span{margin-top:2px;color:rgba(var(--v-theme-on-surface),.46);font-size:10px}.stage-toolbar-actions{display:flex;align-items:center;gap:6px;flex-wrap:wrap;justify-content:flex-end}.stage-rows{display:flex;flex-direction:column;gap:9px}.stage-row-card{min-width:0;padding:11px 12px;border:1px solid rgba(var(--v-theme-on-surface),.065);border-radius:12px;background:rgba(var(--v-theme-surface),.6)}.stage-row-head{display:flex;align-items:center;justify-content:space-between;gap:10px}.stage-row-head>div:first-child{min-width:0;display:flex;flex-direction:column}.stage-row-head strong{color:rgba(var(--v-theme-on-surface),.82);font-size:12px}.stage-row-head span,.stage-row-state{color:rgba(var(--v-theme-on-surface),.45);font-size:10px}.expand-btn{margin-top:9px}.stage-slot-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(54px,1fr));gap:7px;margin-top:10px}.stage-slot{min-width:0;min-height:54px;border:1px dashed var(--stage-slot-border,rgba(var(--v-theme-on-surface),.12));border-radius:11px;color:var(--stage-slot-color,rgba(var(--v-theme-on-surface),.66));background:var(--stage-slot-bg,rgba(var(--v-theme-on-surface),.025));font:inherit;cursor:pointer}.stage-slot.draft{border-style:solid;box-shadow:inset 0 0 0 1px var(--stage-slot-border)}.stage-slot-emoji{font-size:25px}.stage-slot-empty{color:rgba(var(--v-theme-on-surface),.35);font-size:9px}
...
@media (max-width: 900px){.overview-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.bag-grid{grid-template-columns:1fr}.stage-toolbar{align-items:stretch;flex-direction:column}.stage-toolbar-actions{justify-content:flex-start}}
@media (max-width: 600px){
  ...
  .slot-machine-panel{grid-template-columns:minmax(0,1fr) auto}.slot-reels{grid-column:1/-1;grid-row:2}.slot-machine-action{grid-column:2;grid-row:1}.bag-item{grid-template-columns:40px minmax(0,1fr)}.bag-image{width:40px;height:40px}.bag-action{grid-column:1/-1}.bag-action .number-input{flex:1;width:auto}.bag-action :deep(.v-btn){flex:1}
