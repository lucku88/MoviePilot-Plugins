...
@media (max-width: 1100px){.emoji-hub-grid{grid-template-columns:1fr}.emoji-hub-stack{grid-template-rows:auto auto}.emoji-hub-stack>.siqi-card{height:auto}.primary-grid{grid-template-columns:1fr}}
