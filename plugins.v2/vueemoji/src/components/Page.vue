...
@media (max-width: 600px){
  ...
  .bag-grid{grid-template-columns:1fr}.bag-item{grid-template-columns:52px minmax(0,1fr)}.bag-image{width:52px;height:52px}.bag-action{grid-column:1/-1}.bag-action .number-input{flex:1;width:auto}.bag-action :deep(.v-btn){flex:1}.bag-upgrade-row,.bag-tip{grid-column:1/-1}
