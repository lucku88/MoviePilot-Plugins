...
const _hoisted_5 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("div", { class: "siqi-topbar__copy" }, [
  ...
  /*#__PURE__*/_createElementVNode("div", { class: "siqi-topbar__sub" }, "老虎机、表情包与动态舞台演出")
], -1));
...
const _hoisted_18 = { class: "primary-grid mb-3" };
const _hoisted_19 = { class: "schedule-list" };
const _hoisted_20 = { class: "schedule-row__copy" };
const _hoisted_21 = { class: "schedule-row__title" };
const _hoisted_22 = { class: "schedule-row__meta" };
const _hoisted_23 = {
  key: 0,
  class: "summary-panel"
};
const _hoisted_24 = { class: "summary-panel__head" };
const _hoisted_25 = { class: "summary-lines" };
const _hoisted_26 = { class: "section-count" };
const _hoisted_27 = { class: "slot-machine-panel" };
const _hoisted_28 = { class: "slot-machine-copy" };
const _hoisted_29 = { class: "slot-machine-title" };
const _hoisted_30 = { class: "slot-machine-meta" };
const _hoisted_31 = {
  class: "slot-reels",
  "aria-label": "老虎机当前图案"
};
const _hoisted_32 = { class: "slot-machine-action" };
...
const _hoisted_42 = { class: "pending-head" };
const _hoisted_43 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("strong", null, "待处理开包结果", -1));
const _hoisted_44 = { class: "result-emoji" };
const _hoisted_45 = { class: "result-attr" };
const _hoisted_46 = { class: "result-owned" };
const _hoisted_47 = { class: "pending-actions" };
const _hoisted_48 = { class: "card-title-copy" };
const _hoisted_49 = { class: "catalog-progress" };
const _hoisted_50 = { class: "tier-tabs" };
...
const _hoisted_55 = { class: "actor-grid" };
const _hoisted_56 = ["disabled", "onClick"];
const _hoisted_57 = { class: "actor-main" };
const _hoisted_58 = { class: "actor-attr" };
const _hoisted_59 = { class: "actor-count" };
const _hoisted_60 = {
  key: 2,
  class: "actor-actions"
};
const _hoisted_61 = { class: "card-title-copy" };
const _hoisted_62 = { class: "stage-current" };
const _hoisted_63 = { class: "effect-grid" };
const _hoisted_64 = ["disabled", "onClick"];
const _hoisted_65 = { class: "effect-title" };
const _hoisted_66 = { class: "effect-boost" };
const _hoisted_67 = { class: "effect-subline" };
const _hoisted_68 = { class: "effect-unlock" };
const _hoisted_69 = { class: "stage-toolbar" };
const _hoisted_70 = { class: "stage-toolbar-copy" };
const _hoisted_71 = { key: 0 };
const _hoisted_72 = { key: 1 };
const _hoisted_73 = { class: "stage-toolbar-actions" };
const _hoisted_74 = { class: "stage-rows" };
const _hoisted_75 = { class: "stage-row-head" };
const _hoisted_76 = { class: "stage-row-state" };
const _hoisted_77 = {
  key: 1,
  class: "stage-slot-grid"
};
const _hoisted_78 = ["title", "disabled", "onClick"];
const _hoisted_79 = {
  key: 0,
...
const _hoisted_84 = { class: "history-detail" };
const _hoisted_85 = { class: "history-time" };
                    ...
                    default: _withCtx(() => [
                        ...
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(scheduleRows.value, (row) => {
                          return (_openBlock(), _createElementBlock("div", {
                            ...
                            _createElementVNode("div", _hoisted_20, [
                              _createElementVNode("div", _hoisted_21, _toDisplayString(row.title), 1),
                              _createElementVNode("div", _hoisted_22, _toDisplayString(row.meta), 1)
                            ]),
                            _createElementVNode("div", {
                      ...
                      (showSummary.value)
                        ? (_openBlock(), _createElementBlock("div", _hoisted_23, [
                            ...
                            _createElementVNode("div", _hoisted_25, _toDisplayString(summaryLines.value.join(' / ')), 1)
                          ]))
                        : _createCommentVNode("", true)
                    ]),
                    _: 1
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_card_title, { class: "siqi-card-title siqi-card-title--bags d-flex align-center" }, {
                    default: _withCtx(() => [
                      ...
                      _createVNode(_component_v_spacer),
                      _createElementVNode("span", _hoisted_26, _toDisplayString(bags.value.length) + " 个层级", 1)
                    ]),
                    _: 1
                  }),
                  _createVNode(_component_v_card_text, { class: "bag-card-body" }, {
                    default: _withCtx(() => [
                      _createElementVNode("div", _hoisted_27, [
                        _createElementVNode("div", _hoisted_28, [
                          _createElementVNode("div", _hoisted_29, [
                            ...
                            _createTextVNode("老虎机")
                          ]),
                          _createElementVNode("div", _hoisted_30, "今日剩余 " + _toDisplayString(slotMachine.value.remaining || 0) + " 次", 1)
                        ]),
                      ...
                      (pendingOpenVisible.value && pendingOpen.value.items?.length)
                        ? (_openBlock(), _createElementBlock("article", _hoisted_41, [
                          ...
                          _createElementVNode("div", _hoisted_55, [
                            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(visibleActors.value, (actor) => {
                              return (_openBlock(), _createElementBlock("button", {
                                ...
                                _createElementVNode("div", _hoisted_59, "×" + _toDisplayString(draftRemaining(actor.code)), 1)
                              ], 12, _hoisted_56))
                            }), 128))
                          ])
                        ], 2)),
                  ...
                  default: _withCtx(() => [
                    _createElementVNode("div", _hoisted_63, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(effects.value, (effect) => {
                        return (_openBlock(), _createElementBlock("button", {
                          ...
                          _createElementVNode("span", _hoisted_65, _toDisplayString(effect.name), 1),
                          _createElementVNode("span", _hoisted_66, "积分+" + _toDisplayString(effect.point_bonus_pct) + "% · 魔力+" + _toDisplayString(effect.magic_bonus_pct) + "%", 1),
                          _createElementVNode("span", _hoisted_67, _toDisplayString(effect.duration_text || (effect.duration_seconds || 0) + ' 秒'), 1),
                          _createElementVNode("span", _hoisted_68, _toDisplayString(effect.unlocked ? '已解锁' : effect.unlock_text || '未解锁'), 1)
                        ], 10, _hoisted_64))
                      }), 128))
                    ]),
                    _createElementVNode("div", _hoisted_69, [
                      _createElementVNode("div", _hoisted_70, [
                        (stage.value.has_active)
                          ? (_openBlock(), _createElementBlock("strong", _hoisted_71, "演出剩余 " + _toDisplayString(stageRemainText.value), 1))
                          : (_openBlock(), _createElementBlock("strong", _hoisted_72, "当前效果 " + _toDisplayString(selectedEffectName.value), 1)),
                      ...
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(stageRows.value, (row) => {
                        return (_openBlock(), _createElementBlock("article", {
                          ...
                          _createElementVNode("div", _hoisted_75, [
                            ...
                            _createElementVNode("div", _hoisted_76, _toDisplayString(row.unlocked ? '已开 ' + row.slot_count + '/' + row.max_slots + ' 格' : '未解锁'), 1)
                          ]),
                          (row.unlocked)
                            ? (_openBlock(), _createBlock(_component_v_btn, {
                                key: 0,
                            ...
                            ? (_openBlock(), _createElementBlock("div", _hoisted_77, [
                                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(row.slots, (slot) => {
                                  return (_openBlock(), _createElementBlock("button", {
                                    ...
                                    (slot.filled)
                                      ? (_openBlock(), _createElementBlock("span", _hoisted_79, _toDisplayString(slot.emoji), 1))
                                      : (draftMap[slotKey(slot)])
                                        ? (_openBlock(), _createElementBlock("span", _hoisted_80, _toDisplayString(draftMap[slotKey(slot)].emoji), 1))
                                        : (_openBlock(), _createElementBlock("span", _hoisted_81, "待定"))
                                  ], 14, _hoisted_78))
                                }), 128))
                              ]))
                            : _createCommentVNode("", true)
                ...
                _createVNode(_component_v_card_text, { class: "history-body" }, {
                  default: _withCtx(() => [
                    (!historyItems.value.length)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_82, "暂无执行历史"))
                      : (_openBlock(), _createElementBlock("div", _hoisted_83, [
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(historyItems.value, (item) => {
                            return (_openBlock(), _createElementBlock("article", {
                              ...
                              _createElementVNode("div", _hoisted_84, _toDisplayString(historySummary(item)), 1),
                              _createElementVNode("time", _hoisted_85, _toDisplayString(item.time), 1)
                            ]))
                          }), 128))
                        ]))
                  ]),
