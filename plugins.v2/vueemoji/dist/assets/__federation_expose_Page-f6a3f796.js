...
const Page_vue_vue_type_style_index_0_scoped_190066af_lang = '';
...
const _withScopeId = n => (_pushScopeId("data-v-190066af"),n=n(),_popScopeId(),n);
...
const _hoisted_29 = { class: "emoji-hub-stack" };
const _hoisted_30 = { class: "slot-today" };
const _hoisted_31 = {
  class: "slot-reels slot-reels--large",
  "aria-label": "老虎机当前图案"
};
const _hoisted_32 = { class: "slot-center-row" };
const _hoisted_33 = ["max"];
const _hoisted_34 = { class: "recruit-summary" };
const _hoisted_35 = { class: "recruit-summary__icon" };
const _hoisted_36 = { class: "recruit-summary__copy" };
const _hoisted_37 = { class: "recruit-meta-grid" };
const _hoisted_38 = { class: "recruit-meta" };
const _hoisted_39 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("span", null, "下次检查", -1));
const _hoisted_40 = { class: "recruit-meta" };
const _hoisted_41 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("span", null, "时间段", -1));
const _hoisted_42 = { class: "recruit-meta" };
const _hoisted_43 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("span", null, "今日额度", -1));
const _hoisted_44 = { class: "section-count" };
const _hoisted_45 = { class: "bag-grid" };
const _hoisted_46 = {
  key: 1,
  class: "bag-image bag-image--placeholder"
};
const _hoisted_47 = { class: "bag-copy" };
const _hoisted_48 = { class: "bag-name" };
const _hoisted_49 = { class: "bag-count" };
const _hoisted_50 = { class: "bag-action" };
const _hoisted_51 = ["onUpdate:modelValue", "max", "aria-label"];
const _hoisted_52 = {
  key: 2,
  class: "bag-upgrade-row"
};
const _hoisted_53 = { class: "bag-upgrade-tip" };
const _hoisted_54 = { class: "bag-upgrade-controls" };
const _hoisted_55 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("span", { class: "bag-upgrade-label" }, "目标数", -1));
const _hoisted_56 = ["onUpdate:modelValue", "max", "aria-label", "disabled"];
const _hoisted_57 = {
  key: 0,
  class: "pending-panel"
};
const _hoisted_58 = { class: "pending-head" };
const _hoisted_59 = /*#__PURE__*/ _withScopeId(() => /*#__PURE__*/_createElementVNode("strong", null, "待处理开包结果", -1));
const _hoisted_60 = { class: "result-emoji" };
const _hoisted_61 = { class: "result-attr" };
const _hoisted_62 = { class: "result-owned" };
const _hoisted_63 = { class: "pending-actions" };
const _hoisted_64 = { class: "card-title-copy" };
const _hoisted_65 = { class: "catalog-progress" };
const _hoisted_66 = { class: "tier-tabs" };
...
const _hoisted_71 = { class: "actor-grid" };
const _hoisted_72 = ["disabled", "onClick"];
const _hoisted_73 = { class: "actor-main" };
const _hoisted_74 = { class: "actor-attr" };
const _hoisted_75 = { class: "actor-count" };
const _hoisted_76 = {
  key: 2,
  class: "actor-actions"
};
const _hoisted_77 = { class: "card-title-copy" };
const _hoisted_78 = { class: "stage-current" };
const _hoisted_79 = {
  class: "effect-grid",
  "aria-label": "舞台效果选择"
};
const _hoisted_80 = ["aria-pressed", "disabled", "onClick"];
const _hoisted_81 = { class: "effect-title" };
const _hoisted_82 = { class: "effect-boost" };
const _hoisted_83 = { class: "effect-subline" };
const _hoisted_84 = { class: "effect-unlock" };
const _hoisted_85 = { class: "stage-toolbar" };
const _hoisted_86 = { class: "stage-toolbar-copy" };
const _hoisted_87 = { key: 0 };
const _hoisted_88 = { key: 1 };
const _hoisted_89 = { class: "stage-toolbar-actions" };
const _hoisted_90 = { class: "stage-rows" };
const _hoisted_91 = { class: "stage-row-head" };
const _hoisted_92 = { class: "stage-row-state" };
const _hoisted_93 = {
  key: 1,
  class: "stage-slot-grid"
};
const _hoisted_94 = ["title", "disabled", "onClick"];
const _hoisted_95 = {
  key: 0,
...
const _hoisted_100 = { class: "log-item-head" };
const _hoisted_101 = { class: "log-item-detail" };
                ...
                _createVNode(_component_v_card, {
                  ...
                  default: _withCtx(() => [
                    ...
                    _createVNode(_component_v_card_text, { class: "slot-card-body" }, {
                      default: _withCtx(() => [
                        _createElementVNode("div", _hoisted_30, "今日次数：" + _toDisplayString(slotMachine.value.used || 0) + "/" + _toDisplayString(slotMachine.value.limit || 0) + "（基础" + _toDisplayString(slotMachine.value.base || 0) + " + f(hnr*发种等级) " + _toDisplayString(slotMachine.value.extra || 0) + "）", 1),
                          ...
                          default: _withCtx(() => [
                            _createElementVNode("div", _hoisted_34, [
                              ...
                              _createElementVNode("div", _hoisted_36, [
                                ...
                                _createElementVNode("span", null, "目标：" + _toDisplayString(recruitTierText.value), 1)
                              ]),
                              _createVNode(_component_v_btn, {
                                color: "pink",
                                variant: "tonal",
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_card_title, { class: "siqi-card-title siqi-card-title--bags d-flex align-center" }, {
                    default: _withCtx(() => [
                      ...
                      _createVNode(_component_v_spacer),
                      _createElementVNode("span", _hoisted_44, _toDisplayString(bags.value.length) + " 个层级", 1)
                    ]),
                    _: 1
                  }),
                  _createVNode(_component_v_card_text, { class: "bag-card-body" }, {
                    default: _withCtx(() => [
                        ...
                        (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(bags.value, (bag) => {
                          return (_openBlock(), _createElementBlock("article", {
                            ...
                            _createElementVNode("div", _hoisted_47, [
                              _createElementVNode("div", _hoisted_48, _toDisplayString(bag.name), 1),
                              _createElementVNode("div", _hoisted_49, "持有 " + _toDisplayString(bag.quantity), 1)
                            ]),
                            ...
                            (bag.upgrade_rule)
                              ? (_openBlock(), _createElementBlock("div", _hoisted_52, [
                                  _createElementVNode("div", _hoisted_53, _toDisplayString(bag.upgrade_rule.tip), 1),
                      ...
                      (pendingOpenVisible.value && pendingOpen.value.items?.length)
                        ? (_openBlock(), _createElementBlock("article", _hoisted_57, [
                            ...
                            _createElementVNode("div", {
                              ...
                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(pendingOpen.value.items, (item, index) => {
                                return (_openBlock(), _createElementBlock("article", {
                                  ...
                                  _createElementVNode("div", _hoisted_60, _toDisplayString(item.emoji), 1),
                                  _createElementVNode("div", _hoisted_61, "P" + _toDisplayString(item.points) + " · M" + _toDisplayString(item.magic), 1),
                                  _createElementVNode("div", _hoisted_62, "已有 " + _toDisplayString(item.owned_count), 1)
                                ]))
                              }), 128))
                            ], 2),
                  ...
                  default: _withCtx(() => [
                    _createElementVNode("div", _hoisted_66, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(actorTabs.value, (tab) => {
                        ...
                        }, _toDisplayString(tab.name) + " " + _toDisplayString(tab.owned) + "/" + _toDisplayString(tab.total || '❓'), 15, _hoisted_67))
                      }), 128))
                    ]),
                    _createElementVNode("div", _hoisted_68, [
                      (_openBlock(), _createElementBlock(_Fragment, null, _renderList(sortOptions, (item) => {
                        ...
                        }, _toDisplayString(item.label), 11, _hoisted_69)
                      }), 64))
                    ]),
                    (!currentActors.value.length)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_70, "当前层级暂无可用演员"))
                      : (_openBlock(), _createElementBlock("div", {
                          key: 1,
                          ...
                          _createElementVNode("div", _hoisted_71, [
                            (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(visibleActors.value, (actor) => {
                              return (_openBlock(), _createElementBlock("button", {
                                ...
                                _createElementVNode("div", _hoisted_73, _toDisplayString(actor.emoji), 1),
                                _createElementVNode("div", _hoisted_74, "P" + _toDisplayString(actor.points) + " · M" + _toDisplayString(actor.magic), 1),
                                _createElementVNode("div", _hoisted_75, "×" + _toDisplayString(draftRemaining(actor.code)), 1)
                              ], 12, _hoisted_72))
                            }), 128))
                          ])
                        ], 2)),
                  ...
                  default: _withCtx(() => [
                    _createElementVNode("div", _hoisted_79, [
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(effects.value, (effect) => {
                        return (_openBlock(), _createElementBlock("button", {
                          ...
                          _createElementVNode("span", _hoisted_81, _toDisplayString(effect.name), 1),
                          _createElementVNode("span", _hoisted_82, "积分+" + _toDisplayString(effect.point_bonus_pct) + "% · 魔力+" + _toDisplayString(effect.magic_bonus_pct) + "%", 1),
                          _createElementVNode("span", _hoisted_83, _toDisplayString(effect.duration_text || (effect.duration_seconds || 0) + ' 秒'), 1),
                          _createElementVNode("span", _hoisted_84, _toDisplayString(effect.unlocked ? '已解锁' : effect.unlock_text || '未解锁'), 1)
                        ], 10, _hoisted_80))
                      }), 128))
                    ]),
                    _createElementVNode("div", _hoisted_85, [
                      _createElementVNode("div", _hoisted_86, [
                        (stage.value.has_active)
                          ? (_openBlock(), _createElementBlock("strong", _hoisted_87, "演出剩余 " + _toDisplayString(stageRemainText.value), 1))
                          : (_openBlock(), _createElementBlock("strong", _hoisted_88, "当前效果 " + _toDisplayString(selectedEffectName.value), 1)),
                      ...
                      (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(stageRows.value, (row) => {
                        return (_openBlock(), _createElementBlock("article", {
                          ...
                          _createElementVNode("div", _hoisted_91, [
                            ...
                            _createElementVNode("div", _hoisted_92, _toDisplayString(row.unlocked ? '已开 ' + row.slot_count + '/' + row.max_slots + ' 格' : '未解锁'), 1)
                          ]),
                          (row.unlocked)
                            ? (_openBlock(), _createBlock(_component_v_btn, {
                                key: 0,
                            ...
                            ? (_openBlock(), _createElementBlock("div", _hoisted_93, [
                                (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(row.slots, (slot) => {
                                  return (_openBlock(), _createElementBlock("button", {
                                    ...
                                    (slot.filled)
                                      ? (_openBlock(), _createElementBlock("span", _hoisted_95, _toDisplayString(slot.emoji), 1))
                                      : (draftMap[slotKey(slot)])
                                        ? (_openBlock(), _createElementBlock("span", _hoisted_96, _toDisplayString(draftMap[slotKey(slot)].emoji), 1))
                                        : (_openBlock(), _createElementBlock("span", _hoisted_97, "待定"))
                                  ], 14, _hoisted_94))
                                }), 128))
                              ]))
                            : _createCommentVNode("", true)
                ...
                _createVNode(_component_v_card_text, { class: "log-body" }, {
                  default: _withCtx(() => [
                    (!operationLogs.value.length)
                      ? (_openBlock(), _createElementBlock("div", _hoisted_98, "暂无操作日志"))
                      : (_openBlock(), _createElementBlock("div", _hoisted_99, [
                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(operationLogs.value, (item, index) => {
                            return (_openBlock(), _createElementBlock("article", {
                              ...
                              _createElementVNode("div", _hoisted_101, _toDisplayString(item.detail), 1)
                            ]))
                          }), 128))
                        ]))
                  ]),
...
const PageView = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-190066af"]]);
