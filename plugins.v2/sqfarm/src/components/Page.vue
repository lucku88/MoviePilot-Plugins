...
.sq-panel-note { background: linear-gradient(90deg, #eff8eb 0%, #fff8e9 100%); }
.sq-note-title { font-size: 18px; font-weight: 800; margin-bottom: 8px; }
.sq-note-text { color: #665f53; line-height: 1.7; }
